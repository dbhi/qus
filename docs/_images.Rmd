...
Manifests are provided for the following hosts: `amd64`, `arm64v8`, `arm32v7`, `arm32v6`, `i386`, `s390x`, `ppc64le` or `mips64le`. That is, any of the target architectures provided by QEMU can be used on any of those hosts.
...
Apart from those, `aptman/qus:mipsel-d${VERSION}-pkg` is also available.
