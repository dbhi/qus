...
Manifests are provided for the following hosts: `amd64`, `arm64v8`, `arm32v7`, `arm32v6`, `i386`, `s390x`, `ppc64le` or `riscv64`. That is, any of the target architectures provided by QEMU can be used on any of those hosts.
