...
This project uses a modified version of `qemy-binfmt-conf.sh`^[See [umarcor/qemu: series-qemu-binfmt-conf/scripts/qemu-binfmt-conf.sh](https://github.com/umarcor/qemu/blob/series-qemu-binfmt-conf/scripts/qemu-binfmt-conf.sh).], which includes the following enhancements:
