...
Ready-to-use docker images are provided for each of eight host architectures officially supported by Docker, Inc. or built by official images [@docker-official-images]: `amd64`, `i386`, `arm64v8`, `arm32v7`, `arm32v6`, `s390x`, `ppc64le` and `mips64le`.
